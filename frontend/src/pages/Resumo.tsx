    ...
    <>
      ...
      {editing && (
        <EditValueModal
          ...
          onDelete={async () => { await api.patchCategory(editing.id, { active: false }); reload(); }}
          deleteMessage="A categoria some das telas e para de vir todo mês. Os lançamentos antigos são mantidos. Some de todos os meses, não só deste."
        />
      )}
    </>
  );
